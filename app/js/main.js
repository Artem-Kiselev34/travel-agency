...
// if (rooms) {
//   // document.addEventListener('DOMContentLoaded', () => {
//   const fetchProducts = (quantity = 3) => {
//     fetch("./rooms-preview.json")
//       .then((response) => {
...
//                     <div class="swiper-slide"><img src="${data[i].img1}" alt="${data[i].alt}"></div>
//                     <div class="swiper-slide"><img src="${data[i].img2}" alt="${data[i].alt}"></div>
//                     <div class="swiper-slide"><img src="${data[i].img3}" alt="${data[i].alt}"></div>
//                     <div class="swiper-slide"><img src="${data[i].img4}" alt="${data[i].alt}"></div>
//                     <div class="swiper-slide"><img src="${data[i].img5}" alt="${data[i].alt}"></div>
//                   </div>
...
//                 <h3 class="room-descr__type">${data[i].room}</h3>
//                 <div class="area">
...
//                     <span class="book__price">${data[i].price}</span>
//                     <span>за 7 ночей</span>
//                   </div>
//                   <a href="basket.html" class="btn btn--fill btn-book">Забронировать</a>
//                 </div>
//               </div>
//           </div>
//               `;
